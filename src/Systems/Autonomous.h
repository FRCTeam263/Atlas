...
private:
	typedef enum{Reset, LiftCan, Lift1Tote, Stack1Tote, Lift2Totes, Stack2Totes, Lift3Totes,
		DriveToAutoZone, Drop1Tote, DriveTo3rdTote, LineUp2Tote, RotateTo3Tote} AutoMode;
